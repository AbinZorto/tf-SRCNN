...
finalimagebl= scipy.misc.imsave('b.jpeg',blurred_image)
finalimagesr = scipy.misc.imsave('sr.jpeg',ouput_)

psnrresult = skimage.measure.compare_psnr(groudtruth_image,ouput_)
psnrresult2 = skimage.measure.compare_psnr(groudtruth_image,blurred_image)
print(psnrresult)
print(psnrresult2)
